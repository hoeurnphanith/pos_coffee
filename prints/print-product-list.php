...
<body>
	<div class="container-fluid">
		...
		<div class="row text-center">
			<div class="col-12 center" style="font-size: 28px;">របាយការផលិតផលក្នុងស្តុក</div>
		</div>
		<div class="row">
		...
		<table class="table">
			...
			<tbody>
				<?php
					$query = $conn->query("SELECT pro_id,cate_id,cate_name,pro_name,qty,purchase_price,sale_price,date,status FROM view_product_list WHERE qty>0 AND status='Enable'");
					$sum_purchase = 0;
					$sum_sale = 0;
				...
				<tr>
					<td colspan="6" style="text-align:right;border:none;padding-right:20px;font-weight:bold;">តម្លៃសរុបរួម</td><br>
					<td colspan="2" style="text-align:center;"><?php echo $sum_purchase ;?> $</td>
				</tr>
				<tr>
					<td colspan="6" style="text-align:right;border:none;padding-right:20px;font-weight:bold;">តម្លៃលក់ចេញសរុប </td>
					<td colspan="2" style="text-align:center;"><?php echo $sum_sale;?> $</td>
				</tr>
				<tr>
					<td colspan="6" style="text-align:right;border:none;padding-right:20px;font-weight:bold;">ប្រាក់ចំណូលសរុប</td>
...
<script type="text/javascript">
	...
	function ClosePage(){
		window.location = "../product_list_admin_report.php";
	}
</script>
