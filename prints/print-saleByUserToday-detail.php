...
<body>
	<div class="container-fluid">
		...
		<div class="row text-center">
			<div class="col-12 center" style="font-size: 28px;">របាយការណ៍ការលក់ថ្ងៃនេះ</div>
		</div>
		<div class="row">
		...
		<table class="table">
			...
			<tbody>
				<?php
					$query = $conn->query("SELECT username,customer_name,pro_name,sale_date,total,paid,due,payment_type,q,purchase_price,price
