    ...
    <nav class="navbar navbar-static-top" style="background-color:#45aaf2;">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu" style="width:127px;text-align:center;">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <!-- <span id="dayname">Day</span>
                <span id="daynum">00</span>
                <span id="month">Month</span>
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li>
                <ul class="menu">
                      <li>
                        <a href="change-password-user.php">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu icon" data-widget="tree">
        ...
        <li class="active"><a href="dashboard_user.php"><i class="fas fa-tachometer-alt"></i><span>ទំព័រដើម</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="change-password-user.php"><i class="fa-solid fa-user"></i>ផ្លាស់ប្ដូរលេខសម្ងាត់</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="category-user.php"><i class="fa-solid fa-list"></i>បញ្ចីក្រុមផលិតផល</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="user-product-list.php"><i class="fa-solid fa-list"></i>បញ្ចីផលិតផល</a></li>
          </ul>
        </li>

        <li><a href="sale-detail-user.php"><i class="fa-solid fa-cart-plus"></i><span>ការលក់</span></a></li>
        <li><a href="sale-user-list.php"><i class="fas fa-list-ul"></i><span>បញ្ចីការលក់</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="customer-user-list.php"> <i class="fa-solid fa-user-large"></i>អតិថិជន</a></li>
          </ul>
        </li>
...
<script type='text/javascript'>
        $(document).ready(function(){
            $('.viewTodaySale').click(function(){
                $.ajax({
                    url: 'action/ajax-viewTodaySale-User-json.php',
                    type: 'post',
                    data: {},
