    ...
    <table class="table view-SaleByUser table-striped" style="margin-bottom:0px;width:100%">
            ...
            <?php
                 $select = $pdo->prepare("SELECT 
                                sale_id,customer_name,sale_date,payment_type,pro_id,pro_name,qty,price,userid,username,useremail,role ,s_status
                            FROM  view_sale_byuser WHERE sale_date='$date' AND  role='$user' AND username ='$username' AND s_status='Enable'");
