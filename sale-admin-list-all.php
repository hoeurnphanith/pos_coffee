...
?>
        <div class="content-wrapper">
            <section class="content-header">
                <h1 class="dashboard-h1">បញ្ជីការលក់សរុប</h1>
                <small></small>
                <ol class="breadcrumb">
                    ...
                    <div class="box-body">      
                        <div class="col-md-12">
                            <table class="table" id="orderlisttable">
                                ...
                                <tbody>
                                    <?php
                                        $select = $pdo->prepare("SELECT * FROM view_sales WHERE s_status='Enable' ORDER BY sale_id ASC");
                                        $select->execute();
                                        $id =0;
                                            while($row = $select->fetch(PDO::FETCH_OBJ)){
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php 
                                                            if($s_status =="Enable"){
                                                                echo'<td><span class="label" style="background-color: #05c46b;color:white;">'.$s_status.'</span></td>';
                                                            }
                                                        ?>
                                        
                                                        <td><?php echo $staff;?></td>
                                                        <td>
                                                            <a href="prints/print-admin.php?key_id=<?php echo $sale_id;?>" target="_blank"><i class="fa-solid fa-print print btn1"></i></a>  
                                                            <!-- <a href="update-saledetail-admin.php?key_id=<?php echo $sale_id;?>"><i class="fa-solid fa-pen-to-square btn1"></i></a>   -->
