    ...
    <div class="modal fade" id="add-customer">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="action/add-customer-user.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="add-save-customer" class="btn" style="background-color:#9980FA;color:white;padding:7px 18px;border:none;border-radius: 4px;"><i class="fa-solid fa-floppy-disk"></i> បន្ថែមអតិថិជន</button>
                    </div>
                </form>
    ...
    $('document').ready(function(){
        $('body').on('click','.btnadd',function(){
            ...
            $('.productid').on('change',function(e){
                ...
                $.ajax({
                    url:"action/get-product-user-json.php",
                    method:"get",
