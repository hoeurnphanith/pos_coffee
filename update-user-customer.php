<?php
    ...
    if(isset($_POST['btnupdate'])){
        ...
        if($update->execute()){
            ...
            echo '<script type="text/javascript">
                        jQuery(function validation(){
                            window.location.replace("customer-user-list.php");
                        });
                    </script>';
        }else{
                ...
                <div class="box box-info">
                    ...
                    <form role="form" action="" method="post" name="formcategory" style="width:50%;margin-left:0;">
                        ...
                        <div class="box-footer">
                            <a href="customer-user-list.php" class="btn" style="background-color: #ff4757;color:white;"><i class="fa-solid fa-circle-left"></i> ចាកចេញ </a>
